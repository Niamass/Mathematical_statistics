...
def fillTable(sample, segments, n, name):
    # частоты и вероятности попадания в интервалы
...
def сalculation(sample, size, name):
    print(name)
    # вычисление и вывод параметров mu, sigma, числа интервалов k, квантиля chi_2, возвращает отрезки
    segments = processParam(sample, size)
    # вычисление и заполнение таблицы выборочного sample_chi_2
